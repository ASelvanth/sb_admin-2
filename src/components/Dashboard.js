            ...
            <div className="card-body">
                <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                        ...
                        <div className="h5 mb-0 font-weight-bold text-gray-800">{props.data.data.earningMonthly}</div>
                    </div>
                ...
                <div className="row no-gutters align-items-center">
                    <div className="col mr-2">
                        <div className="text-xs font-weight-bold text-success text-uppercase mb-1">
                            Earnings (Annual)</div>
                        <div className="h5 mb-0 font-weight-bold text-gray-800">{props.data.data.earningAnnual}</div>
                    </div>
                    <div className="col-auto">
